...
(payments.py), a printable HTML receipt, shipment editing/cancellation,
and a manual international shipping tier (country fields on sender/
receiver, customs declaration fields, and a zone-based international
quote — see rates.py for how those numbers are set).
