...
def _freshness(iso):
 age=_age(iso);return {"last_success":iso,"age_seconds":round(age,1) if age is not None else None,"fresh":age is not None and age<=MAX_BACKUP_AGE_SECONDS}
